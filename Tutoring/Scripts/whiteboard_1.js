...
function DrawIt(drawObject, syncServer) {
    ...
    if (drawObject.Tool == DrawTool.Line) {
        ...
        switch (drawObject.currentState) {
            ...
            case DrawState.Started:
                ...
                context.fillRect(drawObject.StartX, drawObject.StartY, 50, 50);
                context.restore();
                updatecanvas();
            ...
            case DrawState.Completed:
                context.fillStyle = "#FFFFFF";
                context.fillRect(drawObject.CurrentX, drawObject.CurrentY, 50, 50);
                context.restore();
                updatecanvas();
    ...
    switch (drawObject.currentState) {
        ...
        switch (drawObject.currentState) {
            ...
            case DrawState.Completed:
                ...
                //var startPoint = Math.min(drawObject.StartX, drawObject.StartY);
                //var endPoint = Math.min(drawObject.CurrentX, drawObject.CurrentY);
                context.beginPath();
                //context.arc(drawObject.StartX, drawObject.StartY, drawObject.CurrentX, drawObject.CurrentY, 2 * Math.PI)
                context.ellipse(x, y, w, h, 0, 0, 2 * Math.PI);
                //context.moveTo(drawObject.StartX, drawObject.StartY);
                //context.lineTo(drawObject.StartX, drawObject.CurrentY);
                //context.lineTo(drawObject.CurrentX, drawObject.CurrentY);
                // context.lineTo(y, y);
                context.closePath();
                context.stroke();
    ...
    else if (drawObject.Tool == DrawTool.Triangle) {
        debugger;
        switch (drawObject.currentState) {
            case DrawState.Inprogress:
            case DrawState.Completed:
...
tools.Triangle = function () {
    var tool = this;
    var drawObject = new DrawObject();
    drawObject.Tool = DrawTool.Triangle;
    this.started = false;
...
function ChangeIcons(toolName)
{
    if (toolName == "Triangle")
        $("#imgTriangle").attr({ src: "/images/Triangle.png", border: "1px" });
    else
        $("#imgTriangle").attr({ src: "/images/Triangle.png", border: "0px" });

    if (toolName == "Circle")
        $("#imgCircle").attr({ src: "/images/Circle.png", border: "1px" });
    else
        $("#imgCircle").attr({ src: "/images/Circle.png", border: "0px" });

    if (toolName == "ClearCanvas")
        $("#imgClearCanvas").attr({ src: "/images/Clear.png", border: "1px" });
    else
        $("#imgClearCanvas").attr({ src: "/images/Clear.png", border: "0px" });
